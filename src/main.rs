...
fn main() {
    ...
    let old_board: [[Piece; 8]; 8] = [
        [Castle(Black), Rook(Black), Bishop(Black), Queen(Black), King(Black), Bishop(Black), Rook(Black), Castle(Black)],
        [Empty; 8],
        [Empty; 8],
        [Empty; 8],
        [Empty; 8],
        ...
        [Castle(White), Rook(White), Bishop(White), Queen(White), King(White), Bishop(White), Rook(White), Castle(White)],
    ];
    ...
    let new_board: [[Piece; 8]; 8] = [
        [Empty, Rook(Black), Bishop(Black), Queen(Black), King(Black), Bishop(Black), Rook(Black), Castle(Black)],
        [Empty; 8],
        [Empty; 8],
        [Empty; 8],
        [Empty; 8],
        [Empty; 8],
        [Castle(Black), Empty, Empty, Empty, Empty, Empty, Empty, Empty],
        [Castle(White), Rook(White), Bishop(White), Queen(White), King(White), Bishop(White), Rook(White), Castle(White)],
    ];
